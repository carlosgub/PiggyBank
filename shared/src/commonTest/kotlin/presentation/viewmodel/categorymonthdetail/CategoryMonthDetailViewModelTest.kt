...
class CategoryMonthDetailViewModelTest {
    ...
    @Test
    fun `Get Months Detail Income`() = runTest {
        categoryMonthDetailViewModel.test(
            this, CategoryMonthDetailScreenState(
    ...
    @Test
    fun `Navigate To Edit Expense`() = runTest {
        categoryMonthDetailViewModel.test(this, CategoryMonthDetailScreenState()) {
            expectInitialState()
    ...
    @Test
    fun `Set Initial Configuration`() = runTest {
        categoryMonthDetailViewModel.test(this, CategoryMonthDetailScreenState()) {
            expectInitialState()
    ...
    @Test
    fun `Set Month Detail Screen Model`() = runTest {
        categoryMonthDetailViewModel.test(
            this, CategoryMonthDetailScreenState()
        ) {
            expectInitialState()

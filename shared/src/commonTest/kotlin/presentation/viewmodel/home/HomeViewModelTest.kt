...
class HomeViewModelTest {
    ...
    @Test
    fun `Get Finance Status`() = runTest {
    ...
    @Test
    fun `Navigate To Add Expense`() = runTest {
        homeViewModel.test(this, HomeScreenState()) {
            expectInitialState()
    ...
    @Test
    fun `Navigate To Add Income`() = runTest {
        homeViewModel.test(this, HomeScreenState()) {
            expectInitialState()
    ...
    @Test
    fun `Navigate To Months`() = runTest {
        homeViewModel.test(this, HomeScreenState()) {
            expectInitialState()
    ...
    @Test
    fun `Navigate To Month Detail`() = runTest {
